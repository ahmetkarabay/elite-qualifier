#Autocorrect :
# Need a program that can understand incomplete or misspelled words and autospell them into complete words that are spelled in a similar fashion.
...
# input - gives a word. 
# requires an output for all possible inputes - words. 
# need all the possible words that can be used - safedict_simple.txt.
# needs to be able to take letters from these words and assume words that are being spelled. 
# 